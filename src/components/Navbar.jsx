...
const Navbar = () => {
    ...
    const menuHandleClick = () => setNav(!nav)
    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div className='flex items-center'>
                    ...
                    <ul className='hidden md:flex'>
                        <li><Link className='cursor-pointer' to="home" smooth={true} offset={10} duration={500}>Home</Link></li>
                        <li><Link className='cursor-pointer' to="about" smooth={true} offset={-200} duration={500}>About</Link></li>
                        <li><Link className='cursor-pointer' to="support" smooth={true} offset={-80} duration={500}>Support</Link></li>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} className='cursor-pointer' to="home" smooth={true} offset={10} duration={500}>Home</Link></li>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} className='cursor-pointer' to="support" smooth={true} offset={-80} duration={500}>Support</Link></li>
